...
// DeploymentLock is the Schema for the deploymentlocks API
...
// DeploymentLockList contains a list of DeploymentLock
type DeploymentLockList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DeploymentLock `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DeploymentLock{}, &DeploymentLockList{})
}
