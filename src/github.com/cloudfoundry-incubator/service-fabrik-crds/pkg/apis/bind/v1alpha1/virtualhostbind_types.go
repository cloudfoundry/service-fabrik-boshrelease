...
// VirtualhostBind is the Schema for the virtualhostbinds API
...
// VirtualhostBindList contains a list of VirtualhostBind
...
func init() {
	SchemeBuilder.Register(&VirtualhostBind{}, &VirtualhostBindList{})
}
