...
var _ = Describe("DockerBind", func() {
	var instance DockerBind
	var expected DockerBind
	var client DockerBindInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.BindV1alpha1().DockerBinds("dockerbind-test-valid")
