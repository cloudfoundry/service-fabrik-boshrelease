...
type DeploymentLockInterface interface {
	Create(*v1alpha1.DeploymentLock) (*v1alpha1.DeploymentLock, error)
	Update(*v1alpha1.DeploymentLock) (*v1alpha1.DeploymentLock, error)
	UpdateStatus(*v1alpha1.DeploymentLock) (*v1alpha1.DeploymentLock, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DeploymentLock, error)
	List(opts v1.ListOptions) (*v1alpha1.DeploymentLockList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DeploymentLock, err error)
...
func newDeploymentLocks(c *LockV1alpha1Client, namespace string) *deploymentLocks {
...
func (c *deploymentLocks) Get(name string, options v1.GetOptions) (result *v1alpha1.DeploymentLock, err error) {
	result = &v1alpha1.DeploymentLock{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *deploymentLocks) List(opts v1.ListOptions) (result *v1alpha1.DeploymentLockList, err error) {
	result = &v1alpha1.DeploymentLockList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("deploymentlocks").
...
func (c *deploymentLocks) Create(deploymentLock *v1alpha1.DeploymentLock) (result *v1alpha1.DeploymentLock, err error) {
	result = &v1alpha1.DeploymentLock{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("deploymentlocks").
...
func (c *deploymentLocks) Update(deploymentLock *v1alpha1.DeploymentLock) (result *v1alpha1.DeploymentLock, err error) {
	result = &v1alpha1.DeploymentLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("deploymentlocks").
...
func (c *deploymentLocks) UpdateStatus(deploymentLock *v1alpha1.DeploymentLock) (result *v1alpha1.DeploymentLock, err error) {
	result = &v1alpha1.DeploymentLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("deploymentlocks").
...
func (c *deploymentLocks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DeploymentLock, err error) {
	result = &v1alpha1.DeploymentLock{}
