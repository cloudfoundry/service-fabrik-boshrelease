...
type VirtualhostbindLister interface {
	...
	List(selector labels.Selector) (ret []*bind.Virtualhostbind, err error)
...
// List lists all Virtualhostbinds in the indexer.
func (s *virtualhostbindLister) List(selector labels.Selector) (ret []*bind.Virtualhostbind, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*bind.Virtualhostbind))
	})
	return ret, err
}
...
type VirtualhostbindNamespaceLister interface {
	...
	Get(name string) (*bind.Virtualhostbind, error)
...
// List lists all Virtualhostbinds in the indexer for a given namespace.
func (s virtualhostbindNamespaceLister) List(selector labels.Selector) (ret []*bind.Virtualhostbind, err error) {
...
// Get retrieves the Virtualhostbind from the indexer for a given namespace and name.
func (s virtualhostbindNamespaceLister) Get(name string) (*bind.Virtualhostbind, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(bind.Resource("virtualhostbind"), name)
	}
	return obj.(*bind.Virtualhostbind), nil
}
