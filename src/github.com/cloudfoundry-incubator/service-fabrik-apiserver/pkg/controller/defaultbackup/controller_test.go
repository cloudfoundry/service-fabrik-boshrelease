...
var _ = Describe("DefaultBackup controller", func() {
	var instance DefaultBackup
	var expectedKey string
	var client DefaultBackupInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = DefaultBackup{}
		instance.Name = "instance-1"
		expectedKey = "defaultbackup-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.BackupV1alpha1().DefaultBackups("defaultbackup-controller-test-handler")
