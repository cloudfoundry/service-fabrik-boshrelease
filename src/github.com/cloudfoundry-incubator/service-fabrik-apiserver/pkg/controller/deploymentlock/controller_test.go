...
import (
	...
	. "github.com/cloudfoundry-incubator/service-fabrik-apiserver/pkg/client/clientset_generated/clientset/typed/lock/v1alpha1"
...
var _ = Describe("DeploymentLock controller", func() {
	var instance DeploymentLock
	var expectedKey string
	var client DeploymentLockInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = DeploymentLock{}
		instance.Name = "instance-1"
		expectedKey = "deploymentlock-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.LockV1alpha1().DeploymentLocks("deploymentlock-controller-test-handler")
