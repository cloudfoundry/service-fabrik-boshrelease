...
var _ = Describe("Virtualhost controller", func() {
	var instance Virtualhost
	var expectedKey string
	var client VirtualhostInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "virtualhost-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.DeploymentV1alpha1().Virtualhosts("virtualhost-controller-test-handler")
