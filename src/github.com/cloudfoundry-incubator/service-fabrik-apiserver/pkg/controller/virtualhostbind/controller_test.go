...
package virtualhostbind_test

import (
	"time"

	. "github.com/cloudfoundry-incubator/service-fabrik-apiserver/pkg/apis/bind/v1alpha1"
	. "github.com/cloudfoundry-incubator/service-fabrik-apiserver/pkg/client/clientset_generated/clientset/typed/bind/v1alpha1"
...
var _ = Describe("Virtualhostbind controller", func() {
	var instance Virtualhostbind
	var expectedKey string
	var client VirtualhostbindInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = Virtualhostbind{}
		instance.Name = "instance-1"
		expectedKey = "virtualhostbind-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.BindV1alpha1().Virtualhostbinds("virtualhostbind-controller-test-handler")
