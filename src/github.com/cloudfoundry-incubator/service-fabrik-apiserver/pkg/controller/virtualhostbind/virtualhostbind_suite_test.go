...
var controller *virtualhostbind.VirtualhostbindController
var si *sharedinformers.SharedInformers

func TestVirtualhostbind(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "Virtualhostbind Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = virtualhostbind.NewVirtualhostbindController(config, si)
