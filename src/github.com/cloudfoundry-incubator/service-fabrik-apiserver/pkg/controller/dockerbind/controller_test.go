...
var _ = Describe("DockerBind controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "dockerbind-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.BindV1alpha1().DockerBinds("dockerbind-controller-test-handler")
