...
var _ = Describe("DirectorBind controller", func() {
	var instance DirectorBind
	var expectedKey string
	var client DirectorBindInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = DirectorBind{}
		instance.Name = "instance-1"
		expectedKey = "directorbind-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.BindV1alpha1().DirectorBinds("directorbind-controller-test-handler")
